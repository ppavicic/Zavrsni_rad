    ...
    render() {
        ...
        return (
            <div className="h-100 d-flex flex-column py-1">
                <div className="h-25 pt-3 px-5 border border-secondary text-white bg-secondary bg-gradient d-flex flex-column justify-content-around align-items-center">
                ...
                <form onSubmit={this.handleSubmit} className="w-100 h-75 d-flex flex-column border border-secondary justify-content-center align-items-center">
                    ...
                    <div className="h-25 w-100 bg-secondary d-flex bg-gradient justify-content-center align-items-center">
